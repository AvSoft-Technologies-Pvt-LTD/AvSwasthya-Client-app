...
const Calltoaction = () => {
    return (
       <div className="flex justify-center items-center bg-gray-50 p-10">
        <div className="w-10/12 h-11/12 rounded-3xl shadow-2xl border-2 border-cyan-500">
        <div className="relative bg-gray-50 p-6 z-10 container mx-auto px-6  lg:px-12 rounded-3xl">
            {/* Main CTA Section */}
            <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-10 lg:gap-16">
                ...
                <div className="w-full lg:w-1/2 flex flex-col items-center space-y-9s">
                    <div className="w-[18rem] sm:w-[22rem] h-[10rem] sm:h-[12rem]">
                        <img src={Appointment} alt="Book an appointment" className="w-full h-full object-contain rounded-lg" />
                    </div>
                    <div className="flex flex-wrap gap-4 justify-center">
                        <button className="bg-cyan-600 hover:bg-cyan-700 text-white px-5 py-2 sm:px-6 sm:py-3 rounded-3xl font-semibold shadow-md transition">
                            Generate HealthCard
                        </button>
                        <button className="border border-cyan-600 text-cyan-600 px-5 py-2 sm:px-6 sm:py-3 rounded-3xl font-semibold shadow-md transition hover:bg-cyan-100">
                            Learn More
                        </button>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6">
                    ...
                    <p className="text-base sm:text-lg text-cyan-800 max-w-lg">
            ...
            {/* Form Section at the Bottom */}
                ...
                <form className=" p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="flex items-end">
                        <button className="w-full ml-11 sm:w-auto bg-cyan-600 text-white px-5 py-2 rounded-3xl hover:bg-cyan-700 transition">
                            Quick Appointment
                        </button>
                    </div>
                </form>
