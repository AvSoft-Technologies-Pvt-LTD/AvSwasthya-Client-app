...
import whyChoose1 from "../assets/721b40cf-9d1e-472f-b836-a1c713632708.jpg";
import whyChoose2 from "../assets/team.jpg";
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-4xl font-bold text-cyan-700">
          Why & How <span className="text-cyan-400">AV Swasthya Works?</span>
        </h2>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mt-12">
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <img src={whyChoose1} alt="Healthcare Professional" className="w-full max-w-md object-cover rounded-lg" />
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mt-16">
          <div className="w-full md:w-1/2 flex justify-center">
            <img src={whyChoose2} alt="Healthcare Process" className="w-full max-w-md object-cover rounded-lg" />
          </div>
